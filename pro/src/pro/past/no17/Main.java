...
class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		System.setIn(new java.io.FileInputStream("src/pro/past/no17/sample_input.txt"));
//		System.setIn(new java.io.FileInputStream("C:\\workspaces\\algorithm\\pro\\src\\pro\\past\\no17\\sample_input.txt"));
